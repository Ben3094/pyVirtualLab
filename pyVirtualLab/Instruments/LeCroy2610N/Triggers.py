...
import pyVirtualLab.Instruments.LeCroy2610N.Channels as Channels
from pyVirtualLab.Instruments.LeCroy2610N.Channels import AuxSource, LineSource, AnalogChannel, DigitalChannel

class TriggerCoupling(Enum):
	AC = 'AC'
	DC = 'DC'
	LowFrequencyReject = 'LFREJ'
	HighFrequencyReject = 'HFREJ'
